...
صفحه تنظیمات کلی فعلاً به‌صورت preview آماده است و در مرحله بعد به کالکشن
مرکزی تنظیمات متصل می‌شود تا قواعدی مانند ارز پایه، واحد وزن و دقت اعشار از یک
منبع واحد بر کل برنامه اعمال شوند.
