...
import BankAccountsListModal from './BankAccountsListModal';
import InitialBankInventoryModal from './InitialBankInventoryModal';

export type InitialBankInventoryCardProps = {
  onList?: () => void;
  onAdd?: () => void;
  listHref?: string;
  addHref?: string;
...
export default function InitialBankInventoryCard({
  ...
  return (
    <>
      ...
      >
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3.5">
            <div className="flex size-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-blue-700 text-white shadow-md shadow-blue-500/20">
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs font-medium text-slate-500 dark:text-slate-400">
                تعریف و ثبت موجودی اول دوره حساب‌های بانکی
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Initial Bank Inventory Add Modal */}
      {enableModal && (
