    ...
    initialItems = records.map((r: Record<string, unknown>) => {
      ...
      return {
        ...
        gemstoneType: expandedType
          ...
          : undefined,
        itemName: String(r.item_name || expandedType?.name || 'سنگ بدون نام'),
        mode: (r.mode || 'single_stone') as any,
        category,
        species: String(r.species || expandedType?.species || 'diamond'),
        variety: String(r.variety || expandedType?.variety || ''),
        diamondType: (r.diamond_type || 'natural') as any,
        colorMode: (r.color_mode || 'd_z') as any,
        colorGrade: r.color_grade ? String(r.color_grade) : undefined,
        ...
        clarityGrade: r.clarity_grade ? String(r.clarity_grade) : undefined,
        ...
        fluorescence: r.fluorescence ? String(r.fluorescence) : undefined,
        ...
        tablePercentage: typeof r.table_percentage === 'number' ? r.table_percentage : undefined,
        depthPercentage: typeof r.depth_percentage === 'number' ? r.depth_percentage : undefined,

        certificateLab: String(r.certificate_lab || 'none'),
        certificateReportNumber: r.certificate_report_number ? String(r.certificate_report_number) : undefined,
        ...
        pieces: typeof r.pieces === 'number' ? r.pieces : Number(r.pieces) || 1,

        valuationMethod: (r.valuation_method || 'per_carat') as any,
        costPerCarat: typeof r.cost_per_carat === 'number' ? r.cost_per_carat : undefined,
        costPerGram: typeof r.cost_per_gram === 'number' ? r.cost_per_gram : undefined,
        totalCost: typeof r.total_cost === 'number' ? r.total_cost : Number(r.total_cost) || 0,

        storageLocation: String(r.storage_location || ''),
        internalCode: String(r.internal_code || ''),
