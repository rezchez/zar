...
const appSettingsFields = [
  ...
  { id: 'bool_pwa_enabled', name: 'pwaEnabled', type: 'bool', required: false },
  { id: 'text_pwa_app_name', name: 'pwaAppName', type: 'text', required: false, max: 120 },
  { id: 'text_pwa_short_name', name: 'pwaShortName', type: 'text', required: false, max: 50 },
  { id: 'text_pwa_theme_color', name: 'pwaThemeColor', type: 'text', required: false, max: 30 },
  { id: 'text_pwa_background_color', name: 'pwaBackgroundColor', type: 'text', required: false, max: 30 },
  { id: 'text_pwa_display_mode', name: 'pwaDisplayMode', type: 'text', required: false, max: 30 },
  { id: 'bool_telegram_enabled', name: 'telegramEnabled', type: 'bool', required: false },
  { id: 'text_telegram_bot_token', name: 'telegramBotToken', type: 'text', required: false, max: 200 },
  { id: 'text_telegram_default_chat_id', name: 'telegramDefaultChatId', type: 'text', required: false, max: 100 },
  { id: 'bool_telegram_send_pdf', name: 'telegramSendPdf', type: 'bool', required: false },
  { id: 'bool_telegram_send_text', name: 'telegramSendText', type: 'bool', required: false },
  { id: 'text_telegram_msg_template', name: 'telegramMessageTemplate', type: 'text', required: false, max: 1000 },
  { id: 'bool_bale_enabled', name: 'baleEnabled', type: 'bool', required: false },
  { id: 'text_bale_bot_token', name: 'baleBotToken', type: 'text', required: false, max: 200 },
  { id: 'text_bale_default_chat_id', name: 'baleDefaultChatId', type: 'text', required: false, max: 100 },
  { id: 'bool_bale_send_pdf', name: 'baleSendPdf', type: 'bool', required: false },
  { id: 'bool_bale_send_text', name: 'baleSendText', type: 'bool', required: false },
  { id: 'text_bale_msg_template', name: 'baleMessageTemplate', type: 'text', required: false, max: 1000 },
...
const printTemplatesFields = [
  ...
  { id: 'text_template_type', name: 'templateType', type: 'text', required: false, max: 30 },
