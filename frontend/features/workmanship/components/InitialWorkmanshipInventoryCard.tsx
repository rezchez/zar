...
export type InitialWorkmanshipInventoryCardProps = {
  listHref?: string;
  className?: string;
};

export default function InitialWorkmanshipInventoryCard({
  listHref = '/dashboard/documents/initial-inventory/workmanship',
  className = '',
}: InitialWorkmanshipInventoryCardProps) {
  return (
    <article
      dir="rtl"
    ...
    >
      <div className="relative z-10 space-y-4">
        ...
        <div>
          <h2 className="text-base font-black text-slate-900 dark:text-white">
            موجودی اول دوره کار ساخته
          </h2>
          <p className="mt-1.5 h-10 text-xs leading-5 font-medium text-slate-500 line-clamp-2 dark:text-slate-400">
            ثبت و مدیریت موجودی اولیه انواع النگو، دستبند، سرویس، انگشتر و مصنوعات طلا، نقره و پلاتین
          </p>
        </div>
      </div>
      ...
      <div className="relative z-10 mt-6 border-t border-slate-100 pt-4 dark:border-slate-800">
        ...
        >
          <span>ورود به مدیریت موجودی اول دوره کار ساخته</span>
